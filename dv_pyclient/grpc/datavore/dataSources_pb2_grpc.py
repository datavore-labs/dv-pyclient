...
from datavore import dataSources_pb2 as datavore_dot_dataSources__pb2
...
class RemoteDataSourceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ListDataSources = channel.unary_unary(
        ...
        request_serializer=datavore_dot_dataSources__pb2.ListDataSourcesRequest.SerializeToString,
        response_deserializer=datavore_dot_dataSources__pb2.ListDataSourcesReply.FromString,
        )
    ...
    self.dataSourceQuery = channel.unary_stream(
        ...
        request_serializer=datavore_dot_dataSources__pb2.DataSourceQueryRequest.SerializeToString,
        response_deserializer=datavore_dot_dataSources__pb2.DataRecordsReply.FromString,
        )
...
def add_RemoteDataSourceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ListDataSources': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=datavore_dot_dataSources__pb2.ListDataSourcesRequest.FromString,
          response_serializer=datavore_dot_dataSources__pb2.ListDataSourcesReply.SerializeToString,
      ),
      ...
      'dataSourceQuery': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=datavore_dot_dataSources__pb2.DataSourceQueryRequest.FromString,
          response_serializer=datavore_dot_dataSources__pb2.DataRecordsReply.SerializeToString,
      ),
  }
